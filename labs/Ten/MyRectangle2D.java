...
public class MyRectangle2D {
    ...
    public static boolean r1OverLapsR2(Rectangle r1, Rectangle r2) {
        return r1.intersects(r2.getBounds()) || r2.intersects(r1.getBounds());
    }
    ...
    public static MyRectangle2D getRectangle(MyPoint[] points) {
        ...
        double centerX = (double) highest.getCenterPoint(lowest);
        double centerY = (double) leftMost.getCenterPoint(rightMost);
